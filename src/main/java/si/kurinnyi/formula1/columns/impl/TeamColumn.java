...
public class TeamColumn implements Column {
    ...
    private static final String TITLE = ColumnType.TEAM.toString();
    private static final String COLUMN_FORMAT = "%-" + TableBuilder.teamColumnLength +"s";
    ...
    public String getData(Racer racer) {
        return format(COLUMN_FORMAT, racer.getTeam());
    }
